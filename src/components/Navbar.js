        ...
        <div style={{
          ...
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            <div style={{
              ...
              fontFamily: 'Bebas Neue,cursive', fontSize: '0.9rem', color: '#fff', letterSpacing: 1,
              flexShrink: 0,
            }}>VS</div>
            <span style={{ fontFamily: 'Bebas Neue,cursive', fontSize: '1.4rem', letterSpacing: 3, color: '#e8eaf6' }}>
          ...
          <div className="nav-desktop" style={{ display: 'flex', gap: 2, alignItems: 'center' }}>
            {links.map(l => (
              <Link key={l.to} to={l.to} style={{
                ...
                fontWeight: 600, fontSize: '0.88rem', letterSpacing: 1,
        ...
        <div style={{
          ...
          <div style={{ padding: '1.5rem 1.5rem 2rem', flex: 1 }}>
            ...
            {links.map(l => (
              <Link
                ...
                style={{
                  ...
                  fontSize: '1.4rem', letterSpacing: 3,
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: '2rem' }}>
              <Link to="/login" className="btn-neon" style={{ textDecoration: 'none', textAlign: 'center', fontSize: '1rem', padding: '14px' }}>
                Login
              </Link>
              <Link to="/register" className="btn-neon btn-orange" style={{ textDecoration: 'none', textAlign: 'center', fontSize: '1rem', padding: '14px' }}>
                Register Now
              </Link>
            </div>
          </div>
